...
for row in rows:
	...
	ResponseTools.save_raw_responses_csv(response_objects,output_dir+input_dict['ch1_name']+'-raw.csv')
	ResponseTools.plot_raw_responses(response_objects,plot_dir+input_dict['ch1_name'])
	...
	ResponseTools.save_individual_responses_csv(response_objects,output_dir+input_dict['ch1_name']+'-individual.csv')
	ResponseTools.save_average_responses_csv(response_objects,output_dir+input_dict['ch1_name']+'-average.csv')
	ResponseTools.plot_average_responses(response_objects,plot_dir+input_dict['ch1_name'])
